...
| Banner | [jellyfin-watch-banner.png](../apps/activity-web/public/branding/jellyfin-watch-banner.png) | 1672 × 941 | Bot profile banner and application cover |
...
Neither image contains credentials or private library details.
...
Both assets were created with the built-in image-generation tool on 2026-09-08.
The banner uses the completed icon as its visual reference. Originals were
